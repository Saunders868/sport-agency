      ...
      <Container>
        <div className="mb-12">
          ...
          <p className="mb-5 font-satoshi text-label">
            ...
            game? Experience world-class coaching, state-of-the-are facilities,
            and a vibrant tennis community. Enroll now and be part of a legacy
            of excellence.
          </p>
